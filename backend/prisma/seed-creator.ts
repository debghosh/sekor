  ...
  const locations = await Promise.all([
    prisma.location.create({
      data: {
        ...
        coordinates: { lat: 22.5540, lng: 88.3516 },
        isHistorical: true,
        description: 'Historic commercial and entertainment district',
      },
    }),
    prisma.location.create({
      data: {
        ...
        isHistorical: true,
        description: 'Traditional potters quarter, famous for idol making',
      },
    }),
    prisma.location.create({
      data: {
        ...
        isHistorical: true,
        description: 'Book market and educational hub',
      },
    }),
  ]);
